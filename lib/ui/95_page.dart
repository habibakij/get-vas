...
import 'package:gas_vat/ui/diesel_screen.dart';
...
class NightyFivePage extends StatefulWidget {

  @override
  State<NightyFivePage> createState() => _NightyFivePageState();
}

class _NightyFivePageState extends State<NightyFivePage> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("91",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold),),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("Diesel",style: TextStyle(fontSize: 36,fontWeight: FontWeight.bold),),
                          ),
                          Padding(
